  ...
  return (
    <div className={flexStyle.container}>
      <Table<DataType1> dataSource={tableData1} size="small" pagination={false} bordered>
        ...
        <Column className={cx(flexStyle.columnHeight, fontFamilyStyle.fontFamily)} align="center" title={() => (
          <div style={{ userSelect: 'none', fontWeight: 100 }} onDblClick={() => { state.isShowChart = !state.isShowChart }}>rate</div>
  ...
  return (
    <div className={flexStyle.container}>
      <Table<DataType2> dataSource={tableData2} size="small" pagination={false} bordered>
        ...
        <Column className={cx(flexStyle.columnHeight, fontFamilyStyle.fontFamily)} align="center" title={() => (
          <div style={{ userSelect: 'none', fontWeight: 100 }} onDblClick={() => { state.isShowAll = !state.isShowAll }}>rate</div>
    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (param: any) => {
          ...
          return render(<div className={fontFamilyStyle.fontFamily}>
            <div>{date}</div>
